    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    ...
                    return `<button type="button" class="${this.selectClasses.classSelectTitle}"><img src="img/icons/arrow-down.svg" /> <span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
        ...
        function initSliders() {
            if (document.querySelector(".consultations-slider")) new core(".consultations-slider", {
                ...
                pagination: {
                    el: ".consultations-slider__pagination",
                    clickable: true
                },
                navigation: {
